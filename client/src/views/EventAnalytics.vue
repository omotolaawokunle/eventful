...
<template>
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div v-if="!analytics" class="grid grid-cols-2 lg:grid-cols-4 gap-4">
      <div v-for="i in 4" :key="i" class="bg-white rounded-2xl border border-primary-100 p-6 h-28 animate-pulse" />
    </div>

    <template v-if="analytics">
      <h1 class="font-heading text-4xl text-primary-800 mb-2">{{ analytics.eventTitle }}</h1>
      ...
      <div class="mt-8 bg-white rounded-2xl border border-primary-100 p-6">
